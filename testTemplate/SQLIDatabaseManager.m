...
@implementation SQLIDatabaseManager
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationLibrariesDirectory] URLByAppendingPathComponent:@"testTemplate.sqlite"];
